...
//MainWindow::MainWindow(Client::Client& client, QWidget *parent) : m_client(client), QMainWindow(parent), ui(new Ui::MainWindow)
...
void MainWindow::setClient(Client::Client& client){
    //m_client = client;
}
