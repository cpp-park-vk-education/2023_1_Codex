...
//ProblemTypeWindow::ProblemTypeWindow(Client::Client& client, QWidget *parent) : m_client(client), QMainWindow(parent), ui(new Ui::ProblemTypeWindow)
ProblemTypeWindow::ProblemTypeWindow(QWidget* parent) : QMainWindow(parent), ui(new Ui::ProblemTypeWindow){
    ui->setupUi(this);
...
void ProblemTypeWindow::setClient(Client::Client& client){
    //m_client = client;
}
