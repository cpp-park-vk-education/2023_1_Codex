...
SolutionWindow::SolutionWindow(const Client::ClientSPtr& client, QString value, QWidget* parent) : m_client(client), typeName(value), QMainWindow(parent), ui(new Ui::SolutionWindow){
